...
const app = express();
app.use(cors({
  origin: ['http://localhost:3000', 'https://qrcode-generator.mtandao.app','https://qrcode.mtandao.app','https://qrcode.mtandao.app/QR-code-generator'], // add frontend origin(s) here
