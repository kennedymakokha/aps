...
import { download_qr_code, download_URL_qr_code, generate_qr_code, generate_URL_qr_code, get_qr_code } from '../controllers/generatorController.js'
import multer from 'multer';

const router = express.Router()
const upload = multer({ storage: multer.memoryStorage() });
router.route('/generate-qr').post(upload.single('logo'), generate_qr_code)
...
router.route('/:id').get(get_qr_code)
